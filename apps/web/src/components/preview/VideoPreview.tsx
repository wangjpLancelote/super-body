...
export function VideoPreview({ isOpen, onClose, videoUrl, filename }: VideoPreviewProps) {
  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      <div className="fixed inset-0 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
        <Dialog.Panel className="max-w-7xl max-h-[90vh] bg-black rounded-lg overflow-hidden">
      <div className="relative max-w-7xl max-h-[90vh] bg-black rounded-lg overflow-hidden">
        {/* Video Element */}
        <video
          ref={videoRef}
          src={videoUrl}
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/70 to-transparent p-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={togglePlayPause}
                className="p-2 text-white hover:text-gray-300 rounded hover:bg-white/10"
              >
                {isPlaying ? (
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={onClose}
                className="p-2 text-white hover:text-gray-300 rounded hover:bg-white/10 ml-4"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
        ...
        <div className="absolute top-4 left-4 bg-black/70 text-white px-3 py-1 rounded-lg">
          <span className="text-sm">{filename || 'Video Preview'}</span>
        </div>
      </Dialog.Panel>
      </div>
    </Dialog>
